                ...
                {isEditing ? (
                  <form onSubmit={handleSave} className="space-y-4 max-w-lg">
                    ...
                    <div className="flex items-center justify-between p-3 border rounded-lg bg-gray-50">
                      <div>
                        <label htmlFor="isPrivate" className="font-medium text-gray-800">Cuenta Privada</label>
                        <p className="text-xs text-gray-500">Solo tus seguidores podrán ver tus publicaciones.</p>
                      </div>
